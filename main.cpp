...
int main() {
    ...
    try{ char suvedimas;
        ...
        if (suvedimas == 's') {
                ...
                else if (m == 0) { throw std::invalid_argument("Programa baigė darbą, nes nėra studentų.");}
            ...
            if (budas!='m' && budas!='a') { throw std::invalid_argument("Netinkamas atsakymas suvedimui. Prašome įvesti 'm' arba 'a'."); }
